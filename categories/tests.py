...
class CategoryAPITest(APITestCase):
    ...
    def test_get_categories_default_korean(self):
        url = "/api/categories/"
    ...
    def test_get_categories_with_language_parameter(self):
    ...
    def test_get_categories_with_japanese_language(self):
        ...
        food_category = categories[0]
        self.assertEqual(food_category["name"], "食べ物")
        self.assertEqual(food_category["subcategories"][0]["name"], "韓国料理")

    def test_get_categories_with_chinese_language(self):
        url = "/api/categories/?lang=cn"
        response = self.client.get(url)
        ...
        food_category = categories[0]
        self.assertEqual(food_category["name"], "美食")
        self.assertEqual(food_category["subcategories"][0]["name"], "韩式料理")

    def test_get_categories_with_invalid_language_defaults_to_korean(self):
        url = "/api/categories/?lang=invalid"
        response = self.client.get(url)
